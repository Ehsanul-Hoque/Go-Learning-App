...
class MyNetworkCall<DI, DO> {
  MyNetworkCall({
    required NetworkClient client,
    required NetworkRequest request,
    required NetworkResponse<DO> response,
    required MyJsonConverter<DI, DO> responseConverter,
  ...
  final MyJsonConverter<DI, DO> _responseConverter;
  MyJsonConverter<DI, DO> get responseConverter => _responseConverter;
